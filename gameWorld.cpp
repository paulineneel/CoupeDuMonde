...
void GameWorld::setUpInitialState(){
    ...
    setUpCountryPositions();
    setUpTiles();
}

void GameWorld::setUpCountryPositions(){
    countryPositions.clear();
    countryPositions.push_back(sf::Vector2i(0,2));
    countryPositions.push_back(sf::Vector2i(6,0));
    countryPositions.push_back(sf::Vector2i(2,7));
}   
...
void GameWorld::setUpTiles(){
    ...
    secondRow.push_back(new GameTile("photos/green.png", 50,50,true,true));
    secondRow.push_back(new GameTile("photos/green.png", 100,50,true,false));
    secondRow.push_back(new GameTile("photos/green.png", 150,50,true,false));
    secondRow.push_back(new GameTile("photos/green.png", 200,50,true,false));
    secondRow.push_back(new GameTile("photos/green.png", 250,50,false,false));
    secondRow.push_back(new GameTile("photos/green.png", 300,50,true,false));
    ...
    thirdRow.push_back(new GameTile("photos/green.png", 50,100,true,true));
    thirdRow.push_back(new GameTile("photos/red.png", 100,100,true,false));
    thirdRow.push_back(new GameTile("photos/green.png", 150,100,true,false));
    thirdRow.push_back(new GameTile("photos/green.png", 200,100,true,false));
    thirdRow.push_back(new GameTile("photos/green.png", 250,100,false,false));
    thirdRow.push_back(new GameTile("photos/green.png", 300,100,true,false));
    ...
    fourthRow.push_back(new GameTile("photos/green.png", 50,150,true,true));
    fourthRow.push_back(new GameTile("photos/green.png", 100,150,true,false));
    fourthRow.push_back(new GameTile("photos/red.png", 150,150,true,false));
    fourthRow.push_back(new GameTile("photos/green.png", 200,150,true,false));
    fourthRow.push_back(new GameTile("photos/green.png", 250,150,false,false));
    fourthRow.push_back(new GameTile("photos/green.png", 300,150,true,false));
    ...
    fifthRow.push_back(new GameTile("photos/green.png", 50,200,true,true));
    fifthRow.push_back(new GameTile("photos/green.png", 100,200,true,false));
    fifthRow.push_back(new GameTile("photos/green.png", 150,200,true,false));
    fifthRow.push_back(new GameTile("photos/green.png", 200,200,true,false));
    fifthRow.push_back(new GameTile("photos/green.png", 250,200,false,false));
    fifthRow.push_back(new GameTile("photos/green.png", 300,200,true,false));
    ...
    sixthRow.push_back(new GameTile("photos/green.png", 50,250,true,true));
    sixthRow.push_back(new GameTile("photos/red.png", 100,250,true,false));
    sixthRow.push_back(new GameTile("photos/green.png", 150,250,true,false));
    sixthRow.push_back(new GameTile("photos/green.png", 200,250,true,false));
    sixthRow.push_back(new GameTile("photos/green.png", 250,250,false,false));
    sixthRow.push_back(new GameTile("photos/green.png", 300,250,true,false));
    ...
    seventhRow.push_back(new GameTile("photos/green.png", 50,300,true,true));
    seventhRow.push_back(new GameTile("photos/green.png", 100,300,true,false));
    seventhRow.push_back(new GameTile("photos/green.png", 150,300,true,false));
    ...
    seventhRow.push_back(new GameTile("photos/green.png", 300,300,true,false));
